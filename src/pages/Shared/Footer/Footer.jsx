      ...
      <div>
         <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
            ...
            <nav>
               ...
               <a className="link link-hover">Client support system</a>
               <a className="link link-hover">Email us from author profile</a>
            </nav>
            <nav>
               <h6 className="footer-title">Documentation</h6>
               <a className="link link-hover">Help manual</a>
